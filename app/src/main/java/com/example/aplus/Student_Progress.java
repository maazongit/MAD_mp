...
public class Student_Progress extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String unamec=intent2.getStringExtra("message_key1");
        uname.setText(unamec);
        ...
        Cursor abc1 = sqLiteDatabase.rawQuery("Select Class from Student where Username='" + unamec + "'", null);
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent= new Intent(Student_Progress.this,Student_Remark.class);
