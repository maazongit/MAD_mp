...
public class Student_Remark_adp extends RecyclerView.Adapter<Student_Remark_adp.MyViewHolder> {
    ...
    Student_Remark_adp(Activity activity, Context context, ArrayList Subject, ArrayList Question, ArrayList Class, String cuname) {
    ...
    @NonNull
    @Override
    public Student_Remark_adp.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.myrow, parent, false);
        return new Student_Remark_adp.MyViewHolder(view);
    }
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        ...
        holder.mainLayout1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(context, Student_Remark_view.class);
