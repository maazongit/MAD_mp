...
public class Student_Remark extends AppCompatActivity {
    ...
    Student_Remark_adp student_remark_adp;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseHelper = new DatabaseHelper(Student_Remark.this);
        Subject = new ArrayList<>();
        Question = new ArrayList<>();
        Class =new ArrayList<>();
        student_remark_adp = new Student_Remark_adp(Student_Remark.this, this, Subject, Question,Class,cuname);
        recyclerView.setAdapter(student_remark_adp);
        ...
        if (abc.getCount() == 0) {
            ...
            while (abc.moveToNext()) {
                ...
                recyclerView.setLayoutManager(new LinearLayoutManager(Student_Remark.this));
