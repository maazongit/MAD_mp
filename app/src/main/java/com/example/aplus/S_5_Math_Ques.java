...
public class S_5_Math_Ques extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_s5_math_ques);
        ...
        s2engubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(S_5_Math_Ques.this, "Response submitted Successful", Toast.LENGTH_SHORT).show();
        ...
        s2engfab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ImagePicker.with(S_5_Math_Ques.this)
        ...
        Cursor abc = sqLiteDatabase.rawQuery("Select Title,Option1,Option2,Option3 from Class5math where Question='" + txtque.getText().toString() + "'", null);
