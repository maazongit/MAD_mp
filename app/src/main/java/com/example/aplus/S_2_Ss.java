...
public class S_2_Ss extends AppCompatActivity {
   ...
   S_2_Ss_ADP s_2_ss_adp;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_s2_ss);
        ...
        databaseHelper = new DatabaseHelper(S_2_Ss.this);
        Title = new ArrayList<>();
        Question=new ArrayList<>();
        storeDataInArrays();

        s_2_ss_adp = new S_2_Ss_ADP(S_2_Ss.this, this, Title,Question,uname,class1,sub);
        recyclerView.setAdapter(s_2_ss_adp);
        recyclerView.setLayoutManager(new LinearLayoutManager(S_2_Ss.this));
