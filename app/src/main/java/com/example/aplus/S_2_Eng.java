...
public class S_2_Eng extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_s2_eng);
        ...
        databaseHelper = new DatabaseHelper(S_2_Eng.this);
        Title = new ArrayList<>();
        Question=new ArrayList<>();
        storeDataInArrays();

        customAdapter = new CustomAdapter(S_2_Eng.this, this, Title,Question,uname,class1,sub);
        recyclerView.setAdapter(customAdapter);
        recyclerView.setLayoutManager(new LinearLayoutManager(S_2_Eng.this));
